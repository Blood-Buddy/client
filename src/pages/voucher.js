    ...
    <ScrollView className="bg-[#F2F2F2]">
      <SafeAreaView className="mx-5 px-5">
        <View className="border-b-2 border-b-red-700">
          <Text className="font-bold text-2xl border border-b-red-700 mb-2">
            Voucher
          </Text>
        </View>
        ...
        <View className="flex flex-row gap-8">
          ...
          <View>
            <View style={styles.pointsContainer}>
              <Text className="text-4xl">30</Text>
              <Image
        ...
        <View className="bg-[#F2F2F2] mt-5 p-3 rounded-lg shadow-sm shadow-gray-400 flex flex-row">
          ...
          <View className="mx-4 w-60 ">
            <Text className="text-xl font-normal text-red-700">SAVE 10% OFF</Text>
            ...
            <View className="flex justify-end items-end m-2">
              <View className="bg-red-700 p-1 mt-1 w-28 h-8">
